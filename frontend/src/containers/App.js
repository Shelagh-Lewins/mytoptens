...
import {
	faPencilAlt, faClone, faPlus, faListOl, faStickyNote, faQuestionCircle, faEdit, faBell, faUser,
...
library.add(faPencilAlt, faClone, faPlus, faListOl, faStickyNote, faQuestionCircle, faEdit, faBell, faUser); // and add them to your library
