...
# BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) # settings in project dir
BASE_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))) # settings in subfolder
...
ACCOUNT_EMAIL_CONFIRMATION_ANONYMOUS_REDIRECT_URL = '/verified/'
